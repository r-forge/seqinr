...
\subsection*{release 4.2-12}
\begin{itemize}
\item
Fixing bug spotted by Danny Arends: gap option in dist.alignment is now working for protein sequence.
\end{itemize}
...
% \subsection*{release 3.6-1}

\section*{3.4 series}

% \subsection*{release 3.4-9}

%\subsection*{release 3.4-8}

% \subsection*{release 3.4-7}
...
\includegraphics[width=\textwidth]{../figs/wayback}
\caption{\label{wayback} Screenshot from the internet archive wayback machine showing the \seqinr{} archive listing on CRAN on 09-JUN-2013. Releases from 1.0-7 to 3.1-1, included, are lost for ever in the present CRAN archive for \seqinr{}.}
\end{minipage}}
\end{figure}
