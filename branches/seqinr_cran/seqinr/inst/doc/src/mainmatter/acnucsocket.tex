...
[2] "16578  p4  S+     0:00.00 sh -c ps | grep racnucd"
[3] "16581  p4  R+     0:00.00 grep racnucd"           
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
*******************************************************
Start of remote acnuc server : Wed Mar  5 17:13:53 2008
\end{Soutput}
\begin{Sinput}
 setwd(pwd)
\end{Sinput}
...
Program started at Wed Mar  5 17:14:30 2008

New division created: escherichia_uniprot
Removing updated sequences
0 modified sequences removed
Loading acc nos started at Wed Mar  5 17:14:30 2008
finished at Wed Mar  5 17:14:30 2008
Start loading ncbi species taxonomy
Warning: file $acnuctaxo/id.report not found
Sequence loading started at Wed Mar  5 17:14:30 2008
...
\end{Sinput}
\begin{Soutput}
Program finished at Wed Mar  5 17:14:33 2008
...
\begin{itemize}
  \item \Rlogo{} compilation time was: Wed Mar  5 17:14:35 2008
