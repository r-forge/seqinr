...
\usepackage{/Library/Frameworks/R.framework/Versions/2.5/Resources/share/texmf/Sweave}
\begin{document}
%
...
\section{release 1.0-8}

This is a minor release to remove non ASCII characters in documentation
(*.Rd) files and to declare the encoding as latin1 when necessary in
documentation files (*.Rd). The updated documentation files are: \texttt{
dinucl.Rd,
gb2fasta.Rd,
get.ncbi.Rd,
lseqinr.Rd,
...
words.Rd,
zscore.Rd}.
The very few user-visible changes are as follows:
...
\begin{itemize}
  \item R version 2.5.0 (2007-04-23), \verb|i386-apple-darwin8.9.1|
  \item Locale: \verb|fr_FR.UTF-8/fr_FR.UTF-8/fr_FR.UTF-8/C/fr_FR.UTF-8/fr_FR.UTF-8|
  \item Base packages: base, datasets, grDevices, graphics, methods,
    stats, utils
  \item Other packages: MASS~7.2-33, ade4~1.4-3, ape~1.9-4,
    gee~4.13-12, lattice~0.15-4, nlme~3.1-80, seqinr~1.0-8,
    xtable~1.4-3
\end{itemize}
