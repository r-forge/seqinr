...
\end{Sinput}
\begin{Soutput}
[1] " 5047  p1  S+     0:00.00 ./racnucd racnucd.ini"  
[2] " 5048  p1  S+     0:00.01 sh -c ps | grep racnucd"
[3] " 5050  p1  S+     0:00.00 grep racnucd"           
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
*******************************************************
Start of remote acnuc server : Wed Nov  7 12:08:13 2007
\end{Soutput}
\begin{Sinput}
 setwd(pwd)
\end{Sinput}
...
---->ZUPT_ECOLI
---->ZUR_ECOLI
Program finished at Wed Nov  7 12:08:39 2007

lues=4461  chargees=4461  difference=0 seqs/second=892.20
...
\begin{itemize}
  \item \Rlogo{} compilation time was: Wed Nov  7 12:08:41 2007
