...
\begin{itemize}
  ...
  \item Base packages: base, datasets, grDevices, graphics, grid,
    methods, stats, utils
  \item Other packages: MASS~7.2-36, XML~1.93-2, ade4~1.4-4,
    ape~2.0-1, gee~4.13-13, grImport~0.2-4, lattice~0.16-5,
    nlme~3.1-85, seqinr~1.1-3, xtable~1.5-1
  \item Loaded via a namespace (and not attached): rcompgen~0.1-15,
    tools~2.6.0
\end{itemize}
There were two compilation steps:

\begin{itemize}
  \item \Rlogo{} compilation time was: Mon Oct 29 17:40:22 2007
