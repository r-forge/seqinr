...
\end{Sinput}
\end{Schunk}
\includegraphics{../figs/nonparastats-rho}
\end{center}
...
\end{Sinput}
\end{Schunk}
\includegraphics{../figs/nonparastats-dinuclcoli}
\end{center}
...
\begin{figure}[H]
  \begin{center}
\includegraphics{../figs/nonparastats-GCcoli}
\end{center}
...
\begin{figure}[H]
   \begin{center}
\includegraphics{../figs/nonparastats-GCmicro}
\end{center}
\caption{Density of phototargets, weighted by their frequency in the
...
\begin{figure}[H]
   \begin{center}
\includegraphics{../figs/nonparastats-dinucl-graphes}
\end{center}
...
\begin{figure}[H]
   \begin{center}
\includegraphics{../figs/nonparastats-prochlo}
\end{center}
...
\begin{itemize}
  \item \Rlogo{} compilation time was: Sun Nov  4 19:07:16 2007
