...
\item As pointed out by e-mail on 27-APRIL-2016 by Matthias D\"oring,
 R and Y were note correctly implemented in the  \texttt{comp()} function. This is now fixed.
...
\item As suggested by e-mail on 19-NOVEMBER-2014 by Tang Chin Cheung, examples involving the  \texttt{query()} function  have been modified according to the new features of R-3.1.2:  since R-3.1.2 it is not possible to change an object belonging to the  global environment from a package.
...
\begin{itemize}
  \item \Rlogo{} compilation time was: Fri Jun  3 14:50:04 2016
