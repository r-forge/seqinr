...
\item Function \texttt{dia.bactgensize()} to plot the distribution of
  bacterial genome size from GOLD data \cite{gold1, gold2, gold3, gold4}
 has gained a new arugument
  \texttt{maxgensize} defaulting to 20000 to remove outliers. The
  internal URLs have alse been updated.
...
\begin{itemize}
  ...
  \item Other packages: MASS~7.2-38, ade4~1.4-5, ape~2.0-1,
    gee~4.13-13, lattice~0.17-2, nlme~3.1-86, seqinr~1.1-5,
    xtable~1.5-1
...
\begin{itemize}
  \item \Rlogo{} compilation time was: Sat Dec 15 12:34:49 2007
