...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, grid,
    methods, stats, utils
  \item Other packages: ade4~1.7-3, ape~3.5, grImport~0.9-0,
    MASS~7.3-43, seqinr~3.1-5, tseries~0.10-35, XML~3.98-1.4,
    xtable~1.8-2
  \item Loaded via a namespace (and not attached): lattice~0.20-33,
    nlme~3.1-122, quadprog~1.5-5, tools~3.2.2, zoo~1.7-13
\end{itemize}
There were two compilation steps:

\begin{itemize}
  \item \Rlogo{} compilation time was: Tue Jun  7 13:15:53 2016
