...
\begin{figure}[H]
  \begin{center}
<<rho, echo = TRUE, fig=TRUE, results=hide,height=5,eval=TRUE>>=
...
\begin{figure}[H]
  \begin{center}
<<dinuclcoli, eval = TRUE, echo = TRUE, fig = TRUE>>=
...
\begin{figure}[H]
  \begin{center}
<<GCcoli, echo=F,fig=T,results=hide,height=5,eval=TRUE>>=
...
\begin{figure}[H]
   \begin{center}
<<GCmicro, echo=F,fig=T,results=hide,height=5,eval=TRUE>>=
worstcase = function(gc){
	c = gc
	t = (1-gc)
...
\begin{figure}[H]
   \begin{center}
<<dinucl-graphes,eval=TRUE,echo=FALSE,fig=TRUE>>=
par(mfrow=c(2,2))
...
\begin{figure}[H]
   \begin{center}
<<prochlo,fig=TRUE,echo=FALSE,results=hide,height=3,eval=TRUE>>=
