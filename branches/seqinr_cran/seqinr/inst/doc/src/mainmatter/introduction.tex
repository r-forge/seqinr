...
[2] "         GenBank Rel. 164 (15 February 2008) Last Updated: Feb 24, 2008"         
[3] "86,130,990,994 bases; 83,208,150 sequences; 4,820,660 subseqs; 499,585 refers."  
...
The examples given thereafter were run under \texttt{R version 2.6.2 (2008-02-08)}
on Sun Feb 24 10:24:40 2008 with Sweave \cite{Sweave}. There is a section at the end of
...
\begin{itemize}
  ...
  \item Base packages: base, datasets, grDevices, graphics, methods,
    stats, utils
  \item Other packages: MASS~7.2-40, ade4~1.4-5, ape~2.1,
    gee~4.13-13, lattice~0.17-4, nlme~3.1-86, seqinr~1.1-6,
    xtable~1.5-2
  \item Loaded via a namespace (and not attached): grid~2.6.2,
    rcompgen~0.1-17, tools~2.6.2
\end{itemize}
There were two compilation steps:

\begin{itemize}
  \item \Rlogo{} compilation time was: Sun Feb 24 10:24:45 2008
