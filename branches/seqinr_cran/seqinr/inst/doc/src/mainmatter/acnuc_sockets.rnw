...
\begin{verbatim}
choosebank(host="my_machine",port=6667,info=T)
\end{verbatim}
...
hostname
choosebank(host = hostname,port=6667, info = TRUE)
@ 
...
choosebank(bank = "demoacnuc",host = hostname,port=6667)
