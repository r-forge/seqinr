...
[31] "racnucd.ini"          "racnucd.log"          "requete_acnuc.h"     
...
Finaly, in the RACNUCD\_HOME/ACNUC\_SOFT/racnucd/ directory, lauche the server as follow :
...
\end{Sinput}
\begin{Soutput}
[1] "  610  p1- S      0:00.02 ./racnucd racnucd.ini"  
[2] "17691  p1  S+     0:00.01 sh -c ps | grep racnucd"
[3] "17693  p1  R+     0:00.00 grep racnucd"           
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
*******************************************************
Start of remote acnuc server : Sat Oct 27 10:16:54 2007
\end{Soutput}
\begin{Sinput}
 setwd(pwd)
\end{Sinput}
...
\begin{verbatim}
choosebank(host="my_machine",info=T)
\end{verbatim}
...
---->ZUPT_ECOLI
---->ZUR_ECOLI
Program finished at Sat Oct 27 10:17:19 2007
...
\section{Citation (à faire valider par Manolo)} 
%%%%%%%%%%%%%
...
ACNUC model \cite{acnuc1984, acnuc1985, acnuc1985b}, hosted [at \textit{give your URL if
...
\begin{itemize}
  \item \Rlogo{} compilation time was: Sat Oct 27 10:17:20 2007
