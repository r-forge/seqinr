...
ntaxa <- numeric(0) # there is a good reason for numeric 0
for(i in banks){
...
It was then about \Sexpr{ifelse(exists("tcb"), round(tcb[3]), "???")} seconds to select
...
It was then about \Sexpr{ifelse(exists("tex"), round(tex[3]), "???")} seconds
...
It was then about \Sexpr{ifelse(exists("twl"), round(twl[3]), "???")} seconds
...
It was then about \Sexpr{ifelse(exists("trf"), round(trf[3]), "???")} seconds
...
It was then about \Sexpr{ifelse(exists("tsrd"), round(tsrd[3]), "???")} seconds
...
It was then about \Sexpr{ifelse(exists("tlrd"), round(tlrd[3]), "???")} seconds
...
It was then about \Sexpr{ifelse(exists("texp"), round(texp[3]), "???")} seconds
...
It was then about \Sexpr{ifelse(exists("twl2"), round(twl2[3]), "???")} seconds
...
It was then about \Sexpr{ifelse(exists("trf2"), round(trf2[3]), "???")} seconds
...
It was then about \Sexpr{ifelse(exists("tsrd2"), round(tsrd2[3]), "???")} seconds
...
It was then about \Sexpr{ifelse(exists("tlrd2"), round(tlrd2[3]), "???")} seconds
