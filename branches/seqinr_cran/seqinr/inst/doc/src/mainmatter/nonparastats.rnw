...
\begin{figure}[H]
  \begin{center}
<<dinuclcoli, echo = TRUE, fig = TRUE,eval=F>>=
...
\begin{figure}[H]
  \begin{center}
<<GCcoli, echo=F,fig=T,results=hide,height=5,eval=F>>=
...
\begin{figure}[H]
   \begin{center}
<<dinucl-graphes,echo=FALSE,fig=TRUE,eval=F>>=
par(mfrow=c(2,2))
