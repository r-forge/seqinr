...
region in mitochondrial genomes. An example is not given in the FAQ.
...
\begin{itemize}\raggedright
  ...
  \item Other packages: ade4~1.7-4, ape~3.5, grImport~0.9-0,
    MASS~7.3-45, seqinr~3.3-0, tseries~0.10-35, XML~3.98-1.4,
    xtable~1.8-2
  \item Loaded via a namespace (and not attached): lattice~0.20-33,
    nlme~3.1-128, quadprog~1.5-5, tools~3.3.1, zoo~1.7-13
\end{itemize}
There were two compilation steps:

\begin{itemize}
  \item \Rlogo{} compilation time was: Mon Jul 18 18:29:30 2016
